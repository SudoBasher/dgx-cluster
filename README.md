...
| [CLOUD_ARCHITECTURE.md](CLOUD_ARCHITECTURE.md) | AWS VPN and observability: NetBird, Thanos, Loki, Grafana. Diagrams, design rationale, and what the build changed |
...
| `terraform/` | OpenTofu 1.12.6: VPC, S3, EC2, DNS. All resources tagged `createdBy = tommy.aldo.sonin` |
...
| Observability | Thanos + Loki + Grafana in us-west-2, 18 scrape targets up, 12-month retention |
| Access | NetBird VPN, all peer links direct P2P; nothing public except the VPN control plane |
